...
from MxDjango.settings import MEDIA_ROOT  # (当debug改为true时需要增加)
# from MxDjango.settings import STATIC_ROOT

urlpatterns = [
    url(r'^xadmin/', xadmin.site.urls),

    # 用户注册功能实现
    url(r'^$', IndexView.as_view(), name='index'),         # 取代url(r'^$', TemplateView.as_view(template_name="index.html"), name='index'),这个不用编写view代码
...
#全局404页面配置 【setting中DEBUG = True时是不起作用的】
